...
/* USB-END */
/* BBT-BEGIN */
			{ title: 'Watchdog Mode', name: 'wan'+u+'_ckmtd', type: 'select', options: [['1','Ping'],['2','Traceroute'],['3','Curl*']], value: nvram['wan'+u+'_ckmtd'], suffix: '&nbsp; <small>*default; use the other method only when Curl is not working correctly<\/small>' },
/* BBT-END */
/* BBT0-BEGIN */
			{ title: 'Watchdog Mode', name: 'wan'+u+'_ckmtd', type: 'select', options: [['1','Ping'],['2','Traceroute*']], value: nvram['wan'+u+'_ckmtd'], suffix: '&nbsp; <small>*default; use the other method only when Traceroute is not working correctly<\/small>' },
/* BBT0-END */
...
/* DNSSEC-BEGIN */
		{ title: 'Enable DNSSEC', name: 'f_dnssec_enable', type: 'checkbox', suffix: '&nbsp; <small>must be supported by the upstream nameservers<\/small>', value: (nvram.dnssec_enable == 1) },
/* DNSSEC-END */
/* DNSCRYPT-BEGIN */
