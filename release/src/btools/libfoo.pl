...
#	fixDynDep("libbcm.so", "libc.so.0");
	...
	fixDynDep("php-cgi", "libpng16.so.16.38.0");
	...
	fixDynDep("php-cli", "libpng16.so.16.38.0");
...
genSO("${root}/usr/lib/libpng16.so.16.38.0", "${router}/libpng/.libs/libpng16.a", "", "-L${router}/zlib");
