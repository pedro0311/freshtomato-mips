...
sub fixDyn
{
	...
	fixDynDep("minidlna", "libsqlite3.so.3.51.0");
...
# ipset modules
	...
	fixDynDep("php-cgi", "libsqlite3.so.3.51.0");
	...
	fixDynDep("php-cli", "libsqlite3.so.3.51.0");
	...
	fixDynDep("php-fpm", "libsqlite3.so.3.51.0");
