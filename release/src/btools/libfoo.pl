...
#	fixDynDep("libbcm.so", "libc.so.0");
	...
	fixDynDep("php-cgi", "libxml2.so.2.12.4");
	...
	fixDynDep("php-cli", "libxml2.so.2.12.4");
...
genSO("${root}/usr/lib/libxml2.so.2.12.4", "${router}/libxml2/.libs/libxml2.a", "", "-L${router}/zlib");
