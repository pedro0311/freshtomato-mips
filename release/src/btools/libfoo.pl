...
#	fixDynDep("libbcm.so", "libc.so.0");
	...
	fixDynDep("php-cgi", "libxml2.so.2.11.3");
	...
	fixDynDep("php-cli", "libxml2.so.2.11.3");
...
genSO("${root}/usr/lib/libxml2.so.2.11.3", "${router}/libxml2/.libs/libxml2.a", "", "-L${router}/zlib");
